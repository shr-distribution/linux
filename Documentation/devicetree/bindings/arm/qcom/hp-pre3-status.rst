...
+----------------------+------------------+----------------------------------+
| Proximity/Light      | DT_ADDED         | ISL29040, I2C4 @ 0x44 (no drv)   |
+----------------------+------------------+----------------------------------+
...
+----------------------+------------------+----------------------------------+
| LM8502 LED           | DT_ADDED         | Need driver, I2C4 @ 0x33         |
+----------------------+------------------+----------------------------------+
| LM3528 Backlight     | DT_ADDED         | Need driver, I2C4 @ 0x36         |
+----------------------+------------------+----------------------------------+
...
+----------------------+------------------+----------------------------------+
| ISL29040 driver      | TODO             | Need to add to isl29028.c        |
+----------------------+------------------+----------------------------------+
