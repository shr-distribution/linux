...
| usb-otg-host | 1 | 6 | R1 investigation DONE 2026-05-21 — decision IMPLEMENT (DT-only). vdd50_boost already owns GPIO 102; only need to fix mvs_in-supply (1.8V→5V), set dr_mode=otg, add vbus-supply. R2-R6 pending |
