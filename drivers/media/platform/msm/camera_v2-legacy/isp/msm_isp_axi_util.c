...
#ifdef CONFIG_MSM_AVTIMER
/*
 * Stub: BB OREO ISP uses linux/avtimer_kernel.h directly,
 * not the fptr indirection scheme. Provide an empty exported
 * symbol so techpack/audio/dsp/avtimer.c links cleanly.
 */
