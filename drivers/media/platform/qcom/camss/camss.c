...
static const struct camss_subdev_resources csiphy_res_8x60[] = {
	/* CSIPHY0 */
	{
		 ...
		 * 3. csi_ahb (CSI AHB/peripheral clock)
		 * 4. csi_src, csi, csi_phy
		 */
		.clock = { "vfe", "vfe_csi0", "csi_ahb", "csi0_src", "csi0", "csi0_phy" },
		.clock_rate = { { 0 },
				{ 0 },
				{ 0 },
				{ 0 },
	...
	/* CSIPHY1 */
	{
		 ...
		 * 4. csi_src, csi, csi_phy
		 */
		.clock = { "vfe", "vfe_csi1", "csi_ahb", "csi1_src", "csi1", "csi1_phy" },
		.clock_rate = { { 0 },
				{ 0 },
				{ 0 },
				{ 0 },
...
static const struct camss_subdev_resources vfe_res_8x60[] = {
	/* VFE0 */
	{
		.regulators = {},
		/*
		 * vfe_csi clock must be enabled before CSI clocks can work.
		 * This matches the legacy webOS kernel sequence.
		 */
		.clock = { "vfe", "vfe_axi", "vfe_ahb", "vfe_csi" },
