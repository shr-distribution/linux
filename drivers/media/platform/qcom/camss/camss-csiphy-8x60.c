				     ...
				     s64 link_freq, u8 lane_mask)
{
	...
	dev_dbg(csiphy->camss->dev,
		"CSIPHY%d: lanes=%d settle_cnt=0x%02x link_freq=%lld\n",
		csiphy->id, num_lanes, settle_cnt, link_freq);
	...
	/* Step 5: Configure data lane timing (D0-D3) */
