...
int synaptics_bbry_rmi4_prox_hover_finger_en(bool enable)
{
	int retval;
...
EXPORT_SYMBOL(synaptics_bbry_rmi4_prox_hover_finger_en);
...
{
	synaptics_bbry_rmi4_new_function(&proximity_module, true);
...
{
	synaptics_bbry_rmi4_new_function(&proximity_module, false);
