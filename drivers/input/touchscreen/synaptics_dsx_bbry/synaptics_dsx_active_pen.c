...
{
#if 0
	synaptics_bbry_rmi4_new_function(&active_pen_module, true);
#else
	synaptics_bbry_rmi4_new_function(NULL, &active_pen_module, true);
#endif
...
{
#if 0
	synaptics_bbry_rmi4_new_function(&active_pen_module, false);
#else
	synaptics_bbry_rmi4_new_function(NULL, &active_pen_module, false);
#endif
