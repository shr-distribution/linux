...
#define IDLE_WAIT_POLL_TIME_MS (2000)
...
int fwu_get_device_config_id(struct synaptics_rmi4_data *rmi4_data)
{
	int retval;
...
int synaptics_bbry_fw_updater(struct synaptics_rmi4_fwu_handle *fwu,
...
EXPORT_SYMBOL(synaptics_bbry_fw_updater);
...
static void fwu_startup_fw_update_work(struct work_struct *work)
{
	...
	synaptics_bbry_fw_updater(fwu, NULL);
...
static int synaptics_rmi4_fwu_init(struct synaptics_rmi4_data *rmi4_data)
{
	...
	dev_err(rmi4_data->pdev->dev.parent, "%s:Exit\n", __func__);
	return 0;
...
int synaptics_rmi4_fw_update_module_init(
		struct synaptics_rmi4_data *rmi4_data)
{
	synaptics_bbry_rmi4_new_function(rmi4_data, &fwu_module, true);
