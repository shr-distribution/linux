...
#define FTS_VERBOSE_DBGEN
#define FTS_COMMON_DBG_EN

#ifdef FTS_VERBOSE_DBG_EN
#define FTS_VERBOSE_DBG(fmt, args...)	do {printk("[FTS] %s:%d: "fmt"\n", __FUNCTION__, __LINE__, ##args);} while (0)
#else
#define FTS_VERBOSE_DBG(fmt, args...) do{}while(0)
#endif

#ifdef FTS_COMMON_DBG_EN
#define FTS_COMMON_DBG(fmt, args...)	do {printk("[FTS] %s:%d: "fmt"\n", __FUNCTION__, __LINE__, ##args);} while (0)
