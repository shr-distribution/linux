...
#if defined(GC9503V_DSI_VDO_WVGA_M31_BYD)
	&gc9503v_dsi_vdo_wvga_m31_byd_lcm_drv,
#endif

#if defined(GC9503V_DSI_VDO_WVGA_M31_BYD_HSD)
	&gc9503v_dsi_vdo_wvga_m31_byd_hsd_lcm_drv,
#endif
