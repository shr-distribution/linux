...
#ifdef CONFIG_CPS_WLS_CHARGER
			cps_int_flag = cps_wls_get_int_flag();
			dev_info(mci->dev,"%s cps_int_flag = 0x%x\n", __func__, cps_int_flag);
#endif
...
#ifdef CONFIG_CPS_WLS_CHARGER
			//wls_charger_ovp_en_set(0);
			//wls_charger_ovp_flag_set(1);
			pr_info("%s cps_wls_current = %d ,set cps_wls_current 0\n", __func__, cps_wls_current);
			//cps_wls_current = 0;
#endif
